...
The hierarchy `Omega_total superset Omega_accessible superset Omega_observed superset Omega_represented` is a useful formal distinction. Historical entropy behavior reversed under inverse dynamics, so coarse-graining alone did not establish a fundamental arrow.
